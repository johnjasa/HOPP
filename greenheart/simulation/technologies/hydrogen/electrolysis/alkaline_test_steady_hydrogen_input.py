...
if check_supervisor_func:
    H2_Results,power_consumption_total,hydrogen_production_total,res = run_alkaline_physics(steady_h2_demand,input_signal_type,electrolyzer_size_MW,electrolyzer_config,return_all_results = True)
    []