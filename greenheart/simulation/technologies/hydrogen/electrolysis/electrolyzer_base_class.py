...
class ElectrolyzerCluster(object):
    ...
    def system_design(self,T_stack):
        ...
        if self.electrolyzer_type == "PEM":
            ...
            cell_nominal_h2_kg = self.cell_H2_production_rate(self.nominal_current, T_stack)
...
# -------------------------------------------- #    
    ...
    def run_cluster(self,I_stack_nom):
        ...
        if self.electrolyzer_type == "PEM":
            ...
            hydrogen_produced_kg_nom = self.cell_H2_production_rate(I_stack, self.T_stack)*self.n_cells*self.n_stacks
